...
const qnaList = [
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'c. 상대방에게 먼저 연락 올 때까지 기다린다.', type: [7, 9, 9, 11] },
    ]
  },
  {
    q: '3. 당신의 고백 스타일은?',
    a: [
      ...
      { answer: 'c. 완벽한 분위기, 완벽한 타이밍에서 고백한다.', type: [0, 6, 5, 9] }
    ]
  },
  {
    q: '4. 호감가는 고백 멘트를 고른다면?',
    a: [
      { answer: 'a. 박력 그 자체, "야 나랑 사귀자" ', type: [1, 2, 9 ] },
  ...
  },
  {
    ...
    a: [
      { answer: 'a. 쑥스러워.. 손 잡기 정도??', type: [1, 7, 10, 9, 9 ] },
...

  {
    ...
    a: [
      { answer: 'a. 무슨 기념일이야, 그냥 평소처럼 해', type: [9, 9, 11 ] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'b. 눈치는 채나 말은 꺼내지 않는다', type: [2, 9, 9 ] },
  ...
  },
  {
    ...
    a: [
      { answer: 'a. 각자 만났던 장소에서 헤어진다.', type: [0, 9, 9 ] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'c. 연인에게 연락 올 때까지 무한 카톡, 무한 전화', type: [2, 10, 8, 9 ] },
    ]
  },
  {
    q: '10. 연인이 연락도 없이 보고싶다고 우리집 앞에 와서 기다린다. ',
    a: [
      { answer: 'a. 아니 갑자기 오면 어떡해.. 하 나 준비도 안 했는데 왜 와. 짜증나네', type: [9, 9, 11] },
  ...
  },
  {
    q: '11. 내가 추구하는 연애관은? ',
    a: [
      { answer: 'a. 각자 할 것 하며, 평안하고 안정적인 연애가 좋다.', type: [1, 9, 9, 11 ] },
  ...
  },
  {
    ...
    a: [
      { answer: 'a. "아 화나네. 따라오지마 오늘 집 갈 거니까." 라고 말하며 집으로 간다.', type: [3, 6, 9, 9 ] },
